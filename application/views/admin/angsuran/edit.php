    ...
    <div class="col-12 mb-lg-0 mb-4">
        <div class="card z-index-2 h-100">
            <div class="card-header pb-0 pt-3 bg-transparent">
                <h6 class="text-capitalize">Edit Pinjaman Nasabah</h6>
            </div>
            <div class="card-body p-3">
                <form method="POST" action="<?php echo base_url(); ?>pinjaman/update/<?php echo $pinjaman->id_pinjaman; ?>" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <select class="select_2_class form-control" name="nasabah" required>
                            ...
                            ?>
                            <option value="<?php echo $value->id_nasabah; ?>" <?php if($value->id_nasabah == $pinjaman->id_nasabah) echo "selected" ?>><?php echo $value->nama; ?></option>
                            <?php
                            }
                            ?>
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <img style="height: 300px" src="<?php echo base_url(); ?>assets/foto_nasabah_peminjam/<?php echo $pinjaman->foto; ?>" required />
                        <input class="form-control" type="file" name="foto" placeholder="Foto Nasabah">
                    </div>
                    <div class="form-group">
                        <label for="example-text-input" class="form-control-label">Tanggal Pinjaman</label>
                        <input class="form-control" type="date" name="tgl_pinjaman" value="<?php echo $pinjaman->tgl_pinjaman; ?>" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="number" name="nominal_angsuran" id="input_nominal_angsuran" placeholder="Nominal Angsuran" value="<?php echo $pinjaman->nominal_angsuran; ?>" readonly>
                    </div>
                    <div class="form-group">
