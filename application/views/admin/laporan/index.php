                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <li><a class="dropdown-item" href="<?php echo base_url(); ?>laporan/edit/<?php echo $value->id_laporan; ?>">Edit</a></li>
                                        <li><a class="dropdown-item" href="<?php echo base_url(); ?>laporan/hapus/<?php echo $value->id_laporan; ?>" onclick="return confirm('Yakin Hapus Laporan Ini?')">Hapus</a></li>
                                    </ul>
                                </div>
                            </td>
                        </tr>
