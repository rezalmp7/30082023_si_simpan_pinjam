    ...
    <div class="col-12 mb-lg-0 mb-4">
        <div class="card z-index-2 h-100">
            <div class="card-header pb-0 pt-3 bg-transparent">
                <h6 class="text-capitalize">Tambah Tabungan Nasabah</h6>
            </div>
            <div class="card-body p-3">
                <form method="POST" action="<?php echo base_url(); ?>tabungan/store">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="date" name="tanggal_tabungan">
                    </div>
                    <div class="form-group">
